...
function editarRegistro(llaveRegistro) {
    ...
    $.ajax({
        ...
        url: "https://g4a4b648ae9ebbd-db202110012239.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client/" + llaveRegistro,
...
function actualizar() {
    ...
    if (validarEditar()) {
        $.ajax({
            // la URL para la petición (url: "url al recurso o endpoint")
            url: "https://g4a4b648ae9ebbd-db202110012239.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client",
